...
<template>
  <div
    class="fixed z-50"
    :class="locale === 'ar' ? 'right-4 lg:right-6' : 'left-4 lg:left-6'"
    style="bottom: 1rem;"
  >
    <div
    ...
    >
      ...
      <div class="expanded-content">
        <div class="flex flex-col h-full">
          <!-- Header -->
          <div class="flex items-center justify-between px-5 lg:px-6 h-16 shrink-0 border-b border-white/5">
          ...
          <div class="shrink-0 border-t border-white/5 px-3 py-3">
            <div class="flex items-center gap-3 px-3 py-2">
              ...
              <button
                ...
                :title="locale === 'ar' ? $t('locale.switch_to_en') : $t('locale.switch_to_ar')"
                @click="toggleLocale"
              >
